...
<body>
  ...
  <div class="container mt-5">
    <div class="row">
      <div class="col-md-8">
        ...
        <p>Welcome to PharmaPlus,our mission is to provide safe, effective, and accessible healthcare solutions to patients worldwide.</p>
        <p>At PharmaPlus, With a relentless focus on innovation and quality, we are at the forefront of cutting-edge medical advancements, ensuring that every product we create is a testament to our unwavering commitment to excellence.</p>
        <p>In addition to medications,PharmaPLus are pivotal in creating and distributing drugs, vaccines, and medical devices to enhance human health. </p>
        <p>Thank you for choosing PharmaPlus for your healthcare needs. We look forward to serving you and helping you live a healthier life.</p>
      </div>
      <div class="col-md-4">
        <img src="phar.jpg" class="img-fluid" alt="Pharmacy Image">
      </div>
    </div>
  </div>
  <body background="pharbg.jpg" style="background-repeat: no-repeat; background-size: cover;">
  <br>
  <br>
  <br>
  <br>
  ...
  <footer class="bg-dark text-white text-center py-4 mt-5">
    <p>&copy; 2024 PharmaPlus. All rights reserved. PRASANNA I(212223220079)</p>
  </footer>
...
<body>
  ...
  <body background="pharbg.jpg" style="background-repeat: no-repeat; background-size: cover;"></body>
  <!-- Footer -->
  <footer class="bg-dark text-white text-center py-4 mt-3">
    <p>&copy; 2024 PharmaPlus. All rights reserved.  BY PRASANNA I (212223220079)</p>
  </footer>
...
<body>
    ...
    <div class="row">
      ...
      <div class="col-md-4">
        ...
        <address>
          ...
          1ST FLOOR, ANNA GARDENS, MOUNT POONAMALLEE RD,CHENNAI<br>
          TAMILNADU, 600089<br><br>
          <strong>Email:</strong><br>
          prasanna9887prasanna@gmail.com<br><br>
  ...
  <footer class="bg-dark text-white text-center py-4 mt-2 ">
    <p>&copy; 2024 PharmaPlus. All rights reserved. BY PRASANNA (212223220079)</p>
    ...
    <div class="row">
      <div class="col-md-12">
        ...
        <div class="card-deck">
          ...
          <div class="card">
            <img src="prdrugs.jpeg" class="card-img-top" alt="Product 2" width="200" height="200">
            <div class="card-body">
...
## OUTPUT:
![alt text](<Screenshot 2024-05-12 160939.png>)
![alt text](<Screenshot 2024-05-12 160957.png>)
![alt text](<Screenshot 2024-05-12 161011.png>)
![alt text](<Screenshot 2024-05-12 161121.png>)
## RESULT:
